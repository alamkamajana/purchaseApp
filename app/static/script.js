...
function updateEvent(eventId){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            document.getElementById("fund-info"+eventId).innerHTML = formatOutput(response.fund,2)//.toFixed(2)
...
function cancelUpdateEvent(eventId){
    ...
    document.getElementById("fund-update"+eventId).value = parseFloat(document.getElementById("fund-info"+eventId).innerHTML.trim().replace(/,/g, ''))
